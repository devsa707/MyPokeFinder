...
begin
  ...
  begin
    gridMain.Margins.Left        := Round((Self.Width - 700) / 2);
    gridMain.Margins.Right       := gridMain.Margins.Left;
    gridBackGround.Margins.Left  := gridMain.Margins.Left;
    gridBackGround.Margins.Right := gridMain.Margins.Left;
  end
  else
  begin
    gridMain.Margins.Left        := 0;
    gridMain.Margins.Right       := 0;
    gridBackGround.Margins.Left  := 0;
    gridBackGround.Margins.Right := 0;
  end;
end;
